        ...
        this.updateComment = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                req.on("data", (chunk) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const commentEdited = yield commentService.updateComment({
                        _id: body.id,
                        data: body.data,
                    });
        ...
        this.deleteComment = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                req.on("data", (chunk) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (body.type === 1) {
                        const commentDeleted = yield commentService.deleteComment({
                            _id: body.id,
                        });
                        ...
                        const feedbackDeleted = yield commentService.deleteComment({
                            _id: body.id,
                        });
                        const replyDeleted = yield commentService.deleteReply({
                            parentId: body.id,
                        });
        ...
        this.getAllReplyComments = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                req.on("data", (chunk) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const commentsReply = yield commentService.getAllReplyByCommentIds({
